...
export default class MidsizedMessage extends Message {
    ...
    public static ShowBridgesKnivesProgress(
        title: string,
        totalToDo: number,
        message: string,
        info: string,
    ...
    public static ShowCondensedShardMessage(
        title: string,
        message: string,
        bgColor: HudColor,
        useDarkerShard: boolean,
        time: number = 5000
    ): void {
        this.ShowCustomShard('SHOW_COND_SHARD_MESSAGE', time, title, message, bgColor, useDarkerShard)
    }

    public static ShowMidsizedShardMessage(
        title: string,
        message: string,
        bgColor: HudColor,
        useDarkerShard: boolean,
        useCondensedShard: boolean,
        time: number = 5000
    ): void {
